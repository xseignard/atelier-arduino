...
import { Appear, Deck, Heading, Image, Link, ListItem, List, Slide, Spectacle } from 'spectacle';
		...
		<Deck transition={['zoom', 'fade']} transitionDuration={500}>
			...
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>
							Circuit imprimé open source autour d'un microcontrôleur programmable
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>
							Des entrées et sorties permettant de connecter des capteurs, actionneus,
							etc.
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>
							Un environnement de développement dérivé de celui de Processing
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>S'interfacer avec le monde réel</ListItem>
					</Appear>
					<Appear>
						<ListItem>
							<Link href="http://arduino.cc/" target="_blank">
								http://arduino.cc/
							</Link>
						</ListItem>
					</Appear>
			...
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>des objets connectés</ListItem>
					</Appear>
					<Appear>
						<ListItem>des robots</ListItem>
					</Appear>
					<Appear>
						<ListItem>des machines à dessins</ListItem>
					</Appear>
					<Appear>
						<ListItem>des jardins autonomes</ListItem>
					</Appear>
					<Appear>
						<ListItem>des expositions</ListItem>
					</Appear>
					<Appear>
					...
					<Appear>
						<ListItem>c'est inifini!</ListItem>
					</Appear>
				</List>
			</Slide>
			<Slide bgColor="primary">
			...
			<Slide bgColor="primary">
				<iframe
					width="800"
					height="450"
					src="https://www.youtube.com/embed/TioYIJhdaKo"
					frameBorder="0"
				/>
			</Slide>
			<Slide bgColor="primary">
				<iframe
					width="800"
					height="450"
					src="https://www.youtube.com/embed/18UlWbLTdOU"
					frameBorder="0"
				/>
			</Slide>
			<Slide bgColor="primary">
				<iframe
					width="800"
					height="450"
					src="https://player.vimeo.com/video/68530396?color=ffffff&title=0&byline=0&portrait=0"
					frameBorder="0"
				/>
			</Slide>
			<Slide bgColor="primary">
				<iframe
					width="800"
					height="450"
					src="https://player.vimeo.com/video/126355254?color=ffffff&title=0&byline=0&portrait=0"
					frameBorder="0"
				/>
			</Slide>
			...
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>
							<Link href="http://www.libelium.com/products/waspmote/sensors/">
					...
					<Appear>
						<ListItem>
							<Link href="https://www.sparkfun.com/categories/23?page=all">
								https://www.sparkfun.com/categories/23?page=all
							</Link>
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>et tellement plus.</ListItem>
					</Appear>
				</List>
			</Slide>
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>
							Un "shield" est une carte d'extension que l'on enfiche sur l'arduino
							afin de lui rajouter des fonctionalités
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>
							<Link href="https://www.sparkfun.com/categories/240?page=all">
					...
					<Appear>
						<ListItem>
							<Link href="https://www.adafruit.com/category/21">
			...
			<Slide bgColor="primary">
				...
				<List>
					...
					<Appear>
						<ListItem>MIDI</ListItem>
					</Appear>
					<Appear>
						<ListItem>DMX</ListItem>
					</Appear>
					<Appear>
						<ListItem>RF 433MHz</ListItem>
					</Appear>
					<Appear>
						<ListItem>Réseau téléphoniques</ListItem>
					</Appear>
					<Appear>
						<ListItem>NFC</ListItem>
					</Appear>
					<Appear>
						<ListItem>et tellement plus.</ListItem>
					</Appear>
				...
				ranges={[
					{
						loc: [0, 3],
						note:
							"Ce code s'exécute une seule fois, à la mise sous tension de la carte",
					},
			...
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>
							<Link href="https://www.arduino.cc/en/Guide/HomePage">
					...
					<Appear>
						<ListItem>
							<Link href="https://www.arduino.cc/en/Tutorial/HomePage">
					...
					<Appear>
						<ListItem>
							<Link href="https://www.arduino.cc/en/Reference/HomePage">
			...
			<CodeSlide
				...
				ranges={[
					...
					{
						loc: [3, 4],
						note: 'Démarrer la connection série à la vitesse de 9600 bauds',
					},
			...
			<Slide bgColor="primary">
				...
				<List>
					<Appear>
						<ListItem>Envoyer des données de l'Arduino à Processing</ListItem>
					</Appear>
					<Appear>
						<ListItem>
							Utiliser un potentiomètre pour modifier la couleur d'un sketch
							Processing
						</ListItem>
					</Appear>
					<Appear>
						<ListItem>Utiliser d'autres capteurs</ListItem>
					</Appear>
					<Appear>
						<ListItem>etc.</ListItem>
					</Appear>
